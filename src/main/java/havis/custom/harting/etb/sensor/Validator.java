...
public class Validator {
	...
	private static final ResourceBundle res = 
			ResourceBundle.getBundle("havis.custom.harting.etb.sensor.ui.resourcebundle.ConstantsResource");
	...
	public static havis.custom.harting.etb.sensor.URI createUri(String scheme, String host, String portStr, String username, String password, String path,
			String query, String topic, String clientId, String qosStr) {
		
		havis.custom.harting.etb.sensor.URI uri = new URI();		
	...
	public static havis.custom.harting.etb.sensor.URI parseUri(String uriStr) {		
		URI res = new URI();
